# Generated by Django 2.1.2 on 2018-11-09 07:19
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('account', '0028_auto_20181108_1451'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ResetPasswordToken', to=settings.AUTH_USER_MODEL, verbose_name='The User which is associated to this password reset token')),
            ],
            options={
